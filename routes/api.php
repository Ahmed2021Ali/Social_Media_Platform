...
///////////////////////////////////   friendRequest Route  ///////////////////////////////////
    Route::controller(\App\Http\Controllers\FriendRequestController::class)->prefix('requests')->group(function () {
...
///////////////////////////////////   Comments Route  ///////////////////////////////////
    Route::controller(\App\Http\Controllers\CommentController::class)->prefix('comment')->group(function () {
...
///////////////////////////////////   Interaction Route  ///////////////////////////////////
    Route::controller(\App\Http\Controllers\InteractionController::class)->prefix('interaction')->group(function () {
        Route::post('/create/{post}', 'create');
...
///////////////////////////////////   Interaction Route  ///////////////////////////////////
    Route::controller(\App\Http\Controllers\SharePostController::class)->prefix('sharePost')->group(function () {
        Route::post('/create/{post}', 'create');
